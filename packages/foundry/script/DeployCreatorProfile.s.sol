...
/**
 * @notice Deploy script for CreatorProfile contract
 * @dev Inherits ScaffoldETHDeploy which:
 *      - Includes forge-std/Script.sol for deployment
 *      - Includes ScaffoldEthDeployerRunner modifier
 *      - Provides `deployer` variable
 * Example:
 * yarn deploy --file DeployCreatorProfile.s.sol  # local anvil chain
 * yarn deploy --file DeployCreatorProfile.s.sol --network mantleSepolia # Mantle testnet
 */
contract DeployCreatorProfile is ScaffoldETHDeploy {
    /**
